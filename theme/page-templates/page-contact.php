		...
		<div class="container mx-auto px-4 relative z-10">
			<div class="max-w-4xl mx-auto text-center">
				<h1 class="text-5xl md:text-6xl font-bold text-white mb-6">
					<?php esc_html_e( 'Get In Touch', 'gathathiini' ); ?></h1>
				<p class="text-xl text-gray-300 leading-relaxed">
					<?php esc_html_e( 'We would love to hear from you. Reach out to us for admissions, inquiries, or any questions you may have.', 'gathathiini' ); ?>
				</p>
			</div>
		</div>
	</section>
				...
				<div class="grid lg:grid-cols-2 gap-12">
					...
					<div>
						<h2 class="text-3xl font-bold text-slate-900 mb-6">
							<?php esc_html_e( 'Send Us a Message', 'gathathiini' ); ?></h2>
						<form id="contact-form" class="space-y-6">
							...
							<div class="relative">
								<label for="name"
									class="block text-slate-700 font-semibold mb-2"><?php esc_html_e( 'Your Name', 'gathathiini' ); ?></label>
								<input id="name" name="name" type="text"
									placeholder="<?php esc_attr_e( 'Enter your full name', 'gathathiini' ); ?>"
									class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:outline-none focus:border-cyan-500 transition-colors">
							</div>

							<div class="relative">
								<label for="email"
									class="block text-slate-700 font-semibold mb-2"><?php esc_html_e( 'Email Address', 'gathathiini' ); ?></label>
								<input id="email" name="email" type="email"
									placeholder="<?php esc_attr_e( 'Enter your email', 'gathathiini' ); ?>"
									class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:outline-none focus:border-cyan-500 transition-colors">
							</div>

							<div class="relative">
								<label for="phone"
									class="block text-slate-700 font-semibold mb-2"><?php esc_html_e( 'Phone Number', 'gathathiini' ); ?></label>
								<input id="phone" name="phone" type="tel"
									placeholder="<?php esc_attr_e( 'Enter your phone number', 'gathathiini' ); ?>"
									class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:outline-none focus:border-cyan-500 transition-colors">
							</div>

							<div class="relative">
								<label for="subject"
									class="block text-slate-700 font-semibold mb-2"><?php esc_html_e( 'Subject', 'gathathiini' ); ?></label>
								<select id="subject" name="subject"
									class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:outline-none focus:border-cyan-500 transition-colors">
									<option value=""><?php esc_html_e( 'Select a subject', 'gathathiini' ); ?></option>
									<option><?php esc_html_e( 'Admissions Inquiry', 'gathathiini' ); ?></option>
									<option><?php esc_html_e( 'Academic Information', 'gathathiini' ); ?></option>
									<option><?php esc_html_e( 'Facilities Tour', 'gathathiini' ); ?></option>
									<option><?php esc_html_e( 'General Question', 'gathathiini' ); ?></option>
									<option><?php esc_html_e( 'Other', 'gathathiini' ); ?></option>
								</select>
							</div>

							<div class="relative">
								<label for="message"
									class="block text-slate-700 font-semibold mb-2"><?php esc_html_e( 'Your Message', 'gathathiini' ); ?></label>
								<textarea id="message" name="message" rows="5"
									placeholder="<?php esc_attr_e( 'Tell us more about your inquiry', 'gathathiini' ); ?>"
							...
							<button id="submit-btn" type="submit"
								...
								<span id="btn-text"><?php esc_html_e( 'Send Message', 'gathathiini' ); ?></span>
							</button>
					...
					<div>
						<h2 class="text-3xl font-bold text-slate-900 mb-6">
							<?php esc_html_e( 'Contact Information', 'gathathiini' ); ?></h2>
						<div class="space-y-6 mb-8">
							<div class="flex items-start space-x-4">
								...
								<div>
									<h3 class="text-xl font-bold text-slate-900 mb-2">
										<?php esc_html_e( 'School Location', 'gathathiini' ); ?></h3>
									<p class="text-slate-600">
										<?php esc_html_e( 'Tetu, Nyeri County, Kenya', 'gathathiini' ); ?></p>
								</div>
							</div>
							...
							<div class="flex items-start space-x-4">
								...
								<div>
									<h3 class="text-xl font-bold text-slate-900 mb-2">
										<?php esc_html_e( 'Phone Number', 'gathathiini' ); ?></h3>
									<p class="text-slate-600">+254 725 407 132</p>
									<p class="text-sm text-slate-500 mt-1">
										<?php esc_html_e( 'Monday - Friday: 8:00 AM - 5:00 PM', 'gathathiini' ); ?></p>
								</div>
							</div>
							...
							<div class="flex items-start space-x-4">
								...
								<div>
									<h3 class="text-xl font-bold text-slate-900 mb-2">
										<?php esc_html_e( 'Email Address', 'gathathiini' ); ?></h3>
									<p class="text-slate-600">gathathiini122@gmail.com</p>
									<p class="text-sm text-slate-500 mt-1">
										<?php esc_html_e( 'We respond within 24 hours', 'gathathiini' ); ?></p>
								</div>
							</div>
						</div>
						...
						<div class="bg-gradient-to-br from-slate-50 to-blue-50 rounded-2xl p-8">
							<h3 class="text-xl font-bold text-slate-900 mb-4">
								<?php esc_html_e( 'Office Hours', 'gathathiini' ); ?></h3>
							<div class="space-y-3">
								<div class="flex justify-between">
									<span
										class="text-slate-600"><?php esc_html_e( 'Monday - Friday', 'gathathiini' ); ?></span>
									<span
										class="text-slate-900 font-semibold"><?php esc_html_e( '8:00 AM - 5:00 PM', 'gathathiini' ); ?></span>
								</div>
								<div class="flex justify-between">
									<span
										class="text-slate-600"><?php esc_html_e( 'Saturday', 'gathathiini' ); ?></span>
									<span
										class="text-slate-900 font-semibold"><?php esc_html_e( '9:00 AM - 1:00 PM', 'gathathiini' ); ?></span>
								</div>
								<div class="flex justify-between">
									<span class="text-slate-600"><?php esc_html_e( 'Sunday', 'gathathiini' ); ?></span>
									<span
										class="text-slate-900 font-semibold"><?php esc_html_e( '9:00 AM - 1:00 PM', 'gathathiini' ); ?></span>
								</div>
							</div>
						...
						<div class="mt-8">
							<h3 class="text-xl font-bold text-slate-900 mb-4">
								<?php esc_html_e( 'Follow Us', 'gathathiini' ); ?></h3>
		...
		<div class="container mx-auto px-4">
			<div class="max-w-6xl mx-auto">
				<div class="text-center mb-12">
					<h2 class="text-4xl font-bold text-slate-900 mb-4"><?php esc_html_e( 'Find Us', 'gathathiini' ); ?>
					</h2>
					<p class="text-xl text-slate-600">
						<?php esc_html_e( 'Located in the beautiful region of Tetu, Nyeri County', 'gathathiini' ); ?>
					</p>
				</div>
				<div class="bg-white rounded-3xl p-8 shadow-xl">
					<div class="aspect-video bg-slate-200 rounded-2xl overflow-hidden">
						<iframe
							...
							title="<?php esc_attr_e( 'Gathathi-ini Boys High School Location Map', 'gathathiini' ); ?>">
						</iframe>
					</div>
				</div>
			</div>
		...
		<div class="container mx-auto px-4">
			<div class="max-w-4xl mx-auto text-center">
				...
				<p class="text-xl text-gray-300 mb-8">
					<?php esc_html_e( 'Start your application today and become part of our community.', 'gathathiini' ); ?>
				</p>
