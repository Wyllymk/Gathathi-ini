    ...
    <div class="container mx-auto px-4">
        <nav class="flex items-center justify-between py-4">
            ...
            <div class="hidden lg:flex items-center space-x-8">
                ...
                <a href="#about" class="text-white hover:text-cyan-400 transition-colors font-medium">About</a>
                <a href="#academics" class="text-white hover:text-cyan-400 transition-colors font-medium">Academics</a>
                <a href="#pillars" class="text-white hover:text-cyan-400 transition-colors font-medium">Our
                    Pillars</a>
                <a href="#contact" class="text-white hover:text-cyan-400 transition-colors font-medium">Contact</a>
                <a href="#admissions"
        ...
        <div x-show="mobileMenuOpen" x-transition class="lg:hidden pb-4">
            <div class="flex flex-col space-y-3">
                ...
                <a href="#about" class="text-white hover:text-cyan-400 py-2">About</a>
                <a href="#academics" class="text-white hover:text-cyan-400 py-2">Academics</a>
                <a href="#pillars" class="text-white hover:text-cyan-400 py-2">Our Pillars</a>
                <a href="#contact" class="text-white hover:text-cyan-400 py-2">Contact</a>
                <a href="#admissions"
