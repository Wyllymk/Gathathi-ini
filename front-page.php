        ...
        <main id="main">
            ...
            <section id="features" class="features">
                <div class="container">
                    ...
                    <div class="row gy-4 align-items-center features-item" data-aos="fade-up">
                        <div class="col-md-5">
                            <img src="<?php echo get_template_directory_uri() . '/assets/img/features-3.jpg';?>"
                                class="img-fluid" alt="">
                        </div>
                        <div class="col-md-7">
                            ...
                            <ul>
                                ...
                                <li><i class="bi bi-check"></i> Duis aute irure dolor in reprehenderit in voluptate
                                    velit.</li>
                                <li><i class="bi bi-check"></i> Facilis ut et voluptatem aperiam. Autem soluta ad
                                    fugiat.</li>
                            </ul>
                        </div>
                    </div><!-- Features Item -->
                    ...
                    <div class="row gy-4 align-items-center features-item" data-aos="fade-up">
                        <div class="col-md-5 order-1 order-md-2">
                            <img src="<?php echo get_template_directory_uri() . '/assets/img/features-4.jpg';?>"
                                class="img-fluid" alt="">
                        </div>
                        <div class="col-md-7 order-2 order-md-1">
